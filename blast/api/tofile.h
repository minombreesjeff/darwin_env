...
*
* $Log: tofile.h,v $
* Revision 6.0  1997/08/25 18:07:53  madden
* Revision changed to 6.0
*
* Revision 5.1  1997/06/19 18:39:25  vakatov
...
NLM_EXTERN  Boolean SendTextToFile PROTO((FILE *f, CharPtr text, ParPtr parFmt, ColPtr colFmt));
