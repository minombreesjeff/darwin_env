...
#if defined(_LP64) || defined(_KERNEL)
			IXDR_PUT_U_INT32(buf, objp->dbpcl_id);
			IXDR_PUT_U_INT32(buf, objp->txnpcl_id);
			IXDR_PUT_U_INT32(buf, objp->keydlen);
			IXDR_PUT_U_INT32(buf, objp->keydoff);
			IXDR_PUT_U_INT32(buf, objp->keyulen);
			IXDR_PUT_U_INT32(buf, objp->keyflags);
#else
...
#if defined(_LP64) || defined(_KERNEL)
			objp->dbpcl_id = IXDR_GET_U_INT32(buf);
			objp->txnpcl_id = IXDR_GET_U_INT32(buf);
			objp->keydlen = IXDR_GET_U_INT32(buf);
			objp->keydoff = IXDR_GET_U_INT32(buf);
			objp->keyulen = IXDR_GET_U_INT32(buf);
			objp->keyflags = IXDR_GET_U_INT32(buf);
#else
...
#if defined(_LP64) || defined(_KERNEL)
			IXDR_PUT_INT32(buf, objp->status);
			IXDR_PUT_U_INT32(buf, objp->dbcl_id);
			IXDR_PUT_U_INT32(buf, objp->type);
			IXDR_PUT_U_INT32(buf, objp->dbflags);
			IXDR_PUT_U_INT32(buf, objp->lorder);
#else
...
#if defined(_LP64) || defined(_KERNEL)
			objp->status = IXDR_GET_INT32(buf);
			objp->dbcl_id = IXDR_GET_U_INT32(buf);
			objp->type = IXDR_GET_U_INT32(buf);
			objp->dbflags = IXDR_GET_U_INT32(buf);
			objp->lorder = IXDR_GET_U_INT32(buf);
#else
	...
	__db_pget_msg *objp;
{
	...
	if (xdrs->x_op == XDR_ENCODE) {
		...
		if (buf == NULL) {
			...
			IXDR_PUT_U_INT32(buf, objp->dbpcl_id);
			IXDR_PUT_U_INT32(buf, objp->txnpcl_id);
			IXDR_PUT_U_INT32(buf, objp->skeydlen);
			IXDR_PUT_U_INT32(buf, objp->skeydoff);
			IXDR_PUT_U_INT32(buf, objp->skeyulen);
			IXDR_PUT_U_INT32(buf, objp->skeyflags);
#else
			IXDR_PUT_U_LONG(buf, objp->dbpcl_id);
			IXDR_PUT_U_LONG(buf, objp->txnpcl_id);
		...
		if (buf == NULL) {
			...
			objp->dbpcl_id = IXDR_GET_U_INT32(buf);
			objp->txnpcl_id = IXDR_GET_U_INT32(buf);
			objp->skeydlen = IXDR_GET_U_INT32(buf);
			objp->skeydoff = IXDR_GET_U_INT32(buf);
			objp->skeyulen = IXDR_GET_U_INT32(buf);
			objp->skeyflags = IXDR_GET_U_INT32(buf);
#else
			objp->dbpcl_id = IXDR_GET_U_LONG(buf);
			objp->txnpcl_id = IXDR_GET_U_LONG(buf);
...
#if defined(_LP64) || defined(_KERNEL)
			IXDR_PUT_U_INT32(buf, objp->dbccl_id);
			IXDR_PUT_U_INT32(buf, objp->keydlen);
			IXDR_PUT_U_INT32(buf, objp->keydoff);
			IXDR_PUT_U_INT32(buf, objp->keyulen);
			IXDR_PUT_U_INT32(buf, objp->keyflags);
...
#if defined(_LP64) || defined(_KERNEL)
			objp->dbccl_id = IXDR_GET_U_INT32(buf);
			objp->keydlen = IXDR_GET_U_INT32(buf);
			objp->keydoff = IXDR_GET_U_INT32(buf);
			objp->keyulen = IXDR_GET_U_INT32(buf);
			objp->keyflags = IXDR_GET_U_INT32(buf);
