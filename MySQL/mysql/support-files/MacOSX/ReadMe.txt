2.11. Installing MySQL on Mac OS X
   ...
   all running MySQL server instances by using either the MySQL
...
You cannot install this software on this disk. (null)
   ...
   created as /tmp/mysql.sock by default. See Section 2.7,
   ...
   have been added. See Section 4.4.9, "mysql_upgrade --- Check
...
(Press Control-D or enter "exit" to exit the shell)
   ...
   If you do not use the Startup Item, enter the following
   command sequence:
