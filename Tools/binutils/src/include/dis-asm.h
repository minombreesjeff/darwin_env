...
extern int print_insn_pic12		PARAMS ((bfd_vma, disassemble_info*));
extern int print_insn_pic14		PARAMS ((bfd_vma, disassemble_info*));
extern int print_insn_pic16		PARAMS ((bfd_vma, disassemble_info*));
