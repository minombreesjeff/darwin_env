...
SWIGEXPORT void SWIG_init(void) {
  ...
  SWIG_Python_SetConstant(d, "SVN_VER_PATCH",SWIG_From_long((long)(18)));
  SWIG_Python_SetConstant(d, "SVN_VER_MICRO",SWIG_From_long((long)(18)));
  SWIG_Python_SetConstant(d, "SVN_VER_LIBRARY",SWIG_From_long((long)(1)));
  SWIG_Python_SetConstant(d, "SVN_VER_TAG",SWIG_FromCharPtr(" (r1303927)"));
  SWIG_Python_SetConstant(d, "SVN_VER_NUMTAG",SWIG_FromCharPtr(""));
  SWIG_Python_SetConstant(d, "SVN_VER_REVISION",SWIG_From_long((long)(1303927)));
