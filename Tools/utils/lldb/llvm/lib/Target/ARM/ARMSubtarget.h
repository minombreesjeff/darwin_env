...
protected:
 ...
 public:
  enum {
    ARM_ABI_APCS,
    ARM_ABI_APCS_VFP,  // APCS with VFP (fastcc)
...
public:
  ...
  bool isAPCS_ABI() const {
    return TargetABI == ARM_ABI_APCS || TargetABI == ARM_ABI_APCS_VFP;
  }
  bool isAPCS_VFP_ABI() const { return TargetABI == ARM_ABI_APCS_VFP; }
