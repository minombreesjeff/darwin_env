...
BlockInstrLimit("arm64-ccmp-limit", cl::init(30), cl::Hidden,
...
void SSACCmpConv::convert(SmallVectorImpl<MachineBasicBlock*> &RemovedBlocks) {
  DEBUG(dbgs() << "Merging BB#" << CmpBB->getNumber()
               << " into BB#" << Head->getNumber() << ":\n" << *CmpBB);
  ...
  default: llvm_unreachable("Unknown compare opcode");
  ...
  case ARM64::CBZW:
  case ARM64::CBNZW:
    Opc = ARM64::CCMPWi; FirstOp = 0; isZBranch = true; break;
  case ARM64::CBZX:
  case ARM64::CBNZX:
    Opc = ARM64::CCMPXi; FirstOp = 0; isZBranch = true; break;
  }
...
INITIALIZE_PASS_BEGIN(ARM64ConditionalCompares,
                      "arm64-ccmp", "ARM64 CCMP Pass", false, false)
INITIALIZE_PASS_DEPENDENCY(MachineBranchProbabilityInfo)
INITIALIZE_PASS_DEPENDENCY(MachineDominatorTree)
INITIALIZE_PASS_DEPENDENCY(MachineTraceMetrics)
INITIALIZE_PASS_END(ARM64ConditionalCompares,
                      "arm64-ccmp", "ARM64 CCMP Pass", false, false)
...
bool ARM64ConditionalCompares::runOnMachineFunction(MachineFunction &MF) {
  ...
  MinInstr = 0;
  MinSize = MF.getFunction()->getAttributes().
  ...
  for (df_iterator<MachineDominatorTree*>
       I = df_begin(DomTree), E = df_end(DomTree); I != E; ++I)
