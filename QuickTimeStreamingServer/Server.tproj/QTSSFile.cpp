...
/*
    ...
    $Log: QTSSFile.cpp,v $
    Revision 1.8  2003/08/15 23:53:21  sbasu
    3370815 Need to update to the APSL 2
    Bug #:
    Submitted by:
    Reviewed by:

    Revision 1.7  2003/04/05 03:25:45  murata
    Fix windows build.
    1) remove or add #ifdefs for windows
    2) fix unintentional type casts and conversions
    3) fix bad use of c++ this pointer in constructors
    4) fix general warnings.
    Bug #:
    Submitted by:
    Reviewed by:

    Revision 1.6  2002/02/26 00:25:29  murata
