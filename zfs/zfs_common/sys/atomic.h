...
#define atomic_add_32_nv(addr, amt)	(uint32_t)OSAddAtomic(amt, (volatile SInt32 *)addr)
#define atomic_add_64_nv(addr, amt)	(uint64_t)OSAddAtomic64(amt, (volatile SInt64 *)addr)
